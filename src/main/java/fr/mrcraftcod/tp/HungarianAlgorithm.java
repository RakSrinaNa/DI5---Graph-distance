...
public class HungarianAlgorithm{
	...
	public static void printTime(double time){ //Formats time output.
		...
		LOGGER.info("Total time required: " + timeElapsed);
	}
	...
	public static void generateRandomArray(double[][] array, String randomMethod){//Generates random 2-D array.
	...
	public static double findLargest(double[][] array){//Finds the largest element in a positive array. //works for arrays where all values are >= 0.
		double largest = 0;
  ...
  */
	...
	public static double findSmallest(double[][] cost, int[] rowCover, int[] colCover, double maxCost){//Aux 1 for hg_step6.
